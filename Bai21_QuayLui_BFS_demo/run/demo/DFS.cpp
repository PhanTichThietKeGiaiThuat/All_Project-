...
//0 1 0 0
//1 1 0 0
//+ Dòng d?u tiên là s? d?nh
//+ Các dòng còn l?i bi?u di?n ma tr?n k? c?a d? th? G
//
//Yêu c?u:
//+ In ma trân k? v?a d?c du?c
//+ Duy?t d? th? v?i thu?t toán DFS, BFS. In k?t qua ra màn hình
//+ Ð?m s? thành ph?n liên thông
//+ Ki?m tra xem d? th? có ph?i là Euler không?
#include <iostream>
#include <stdio.h>
#include <conio.h>
#include <values.h>
